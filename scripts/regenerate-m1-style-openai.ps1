...
$backupDir = Join-Path $imagesDir "_backup-openai-m1-style-$stamp"
...
function Prompt-Base {
  return @(
    ...
    "Visual style must match MAKI SAUMON reference style (M1): same plate size, same framing, same light, same 3/4 front camera angle.",
